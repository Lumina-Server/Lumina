...
public final class BedrockToJavaTranslator {
    ...
    public Object translate(Object bedrockThing) {
        if (bedrockThing == null) {
            return null;
        }

        if (bedrockThing instanceof BedrockPacket packet) {
            return packet;
        }
